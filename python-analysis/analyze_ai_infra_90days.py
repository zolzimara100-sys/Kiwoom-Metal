"""
AI Infra 섹터 종목 90일 분석 스크립트
"""

import psycopg2
from decimal import Decimal

def analyze_ai_infra_90days():
    db_config = {
        'host': 'localhost',
        'port': 5432,
        'database': 'kiwoom',
    ...
    try:
        ...
        count = len(amounts)
        ma_90 = total / count if count > 0 else 0
        
        print(f"\n★ 90일 이동평균 (MA90) = {total:,.0f} / {count}")
        print(f"                       = {ma_90:,.0f}원")
