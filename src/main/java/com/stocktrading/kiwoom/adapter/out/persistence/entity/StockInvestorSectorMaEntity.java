...
/**
 * 섹터별 투자자 이동평균 엔티티
 * tb_stock_investor_sector_ma 테이블 매핑
 */
@Entity
@Table(name = "tb_stock_investor_sector_ma")
@IdClass(StockInvestorSectorMaId.class)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class StockInvestorSectorMaEntity {

    @Id
    @Column(name = "sector_cd", length = 50)
    ...
    @Column(name = "sector_nm", length = 50)
    private String sectorNm;

    // 외국인 (Foreigner)
    @Column(name = "frgnr_invsr_ma5", precision = 15)
    private BigDecimal frgnrInvsrMa5;

    @Column(name = "frgnr_invsr_ma10", precision = 15)
    private BigDecimal frgnrInvsrMa10;

    @Column(name = "frgnr_invsr_ma20", precision = 15)
    ...
    @Column(name = "frgnr_invsr_ma60", precision = 15)
    ...
    // 기관계 (Organ)
    @Column(name = "orgn_ma5", precision = 15)
    private BigDecimal orgnMa5;

    @Column(name = "orgn_ma10", precision = 15)
    private BigDecimal orgnMa10;

    @Column(name = "orgn_ma20", precision = 15)
    ...
    @Column(name = "orgn_ma60", precision = 15)
    ...
    // 외인+기관 (Foreigner + Organ)
    @Column(name = "frgnr_orgn_ma5", precision = 15)
    private BigDecimal frgnrOrgnMa5;

    @Column(name = "frgnr_orgn_ma10", precision = 15)
    private BigDecimal frgnrOrgnMa10;

    @Column(name = "frgnr_orgn_ma20", precision = 15)
    private BigDecimal frgnrOrgnMa20;

    @Column(name = "frgnr_orgn_ma30", precision = 15)
    private BigDecimal frgnrOrgnMa30;

    @Column(name = "frgnr_orgn_ma40", precision = 15)
    private BigDecimal frgnrOrgnMa40;

    @Column(name = "frgnr_orgn_ma50", precision = 15)
    private BigDecimal frgnrOrgnMa50;

    @Column(name = "frgnr_orgn_ma60", precision = 15)
    private BigDecimal frgnrOrgnMa60;

    @Column(name = "frgnr_orgn_ma90", precision = 15)
    private BigDecimal frgnrOrgnMa90;

    @Column(name = "frgnr_orgn_ma120", precision = 15)
    private BigDecimal frgnrOrgnMa120;

    @Column(name = "frgnr_orgn_ma140", precision = 15)
    private BigDecimal frgnrOrgnMa140;

    // 개인투자자 (Individual Investor)
    @Column(name = "ind_invsr_ma5", precision = 15)
    private BigDecimal indInvsrMa5;

    @Column(name = "ind_invsr_ma10", precision = 15)
    private BigDecimal indInvsrMa10;

    @Column(name = "ind_invsr_ma20", precision = 15)
    ...
    @Column(name = "ind_invsr_ma60", precision = 15)
    ...
    @Column(name = "fnnc_invt_ma5", precision = 15)
    private BigDecimal fnncInvtMa5;

    @Column(name = "fnnc_invt_ma10", precision = 15)
    private BigDecimal fnncInvtMa10;

    @Column(name = "fnnc_invt_ma20", precision = 15)
    ...
    @Column(name = "fnnc_invt_ma60", precision = 15)
    ...
    // 보험 (Insurance)
    @Column(name = "insrnc_ma5", precision = 15)
    private BigDecimal insrncMa5;

    @Column(name = "insrnc_ma10", precision = 15)
    private BigDecimal insrncMa10;

    @Column(name = "insrnc_ma20", precision = 15)
    ...
    @Column(name = "insrnc_ma60", precision = 15)
    ...
    // 투신 (Investment Trust)
    @Column(name = "invtrt_ma5", precision = 15)
    private BigDecimal invtrtMa5;

    @Column(name = "invtrt_ma10", precision = 15)
    private BigDecimal invtrtMa10;

    @Column(name = "invtrt_ma20", precision = 15)
    ...
    @Column(name = "invtrt_ma60", precision = 15)
    ...
    // 기타금융 (Other Finance)
    @Column(name = "etc_fnnc_ma5", precision = 15)
    private BigDecimal etcFnncMa5;

    @Column(name = "etc_fnnc_ma10", precision = 15)
    private BigDecimal etcFnncMa10;

    @Column(name = "etc_fnnc_ma20", precision = 15)
    ...
    @Column(name = "etc_fnnc_ma60", precision = 15)
    ...
    // 은행 (Bank)
    @Column(name = "bank_ma5", precision = 15)
    private BigDecimal bankMa5;

    @Column(name = "bank_ma10", precision = 15)
    private BigDecimal bankMa10;

    @Column(name = "bank_ma20", precision = 15)
    ...
    @Column(name = "bank_ma60", precision = 15)
    ...
    // 연기금등 (Pension Fund)
    @Column(name = "penfnd_etc_ma5", precision = 15)
    private BigDecimal penfndEtcMa5;

    @Column(name = "penfnd_etc_ma10", precision = 15)
    private BigDecimal penfndEtcMa10;

    @Column(name = "penfnd_etc_ma20", precision = 15)
    ...
    @Column(name = "penfnd_etc_ma60", precision = 15)
    ...
    // 국가 (Nation)
    @Column(name = "samo_fund_ma5", precision = 15)
    private BigDecimal samoFundMa5;

    @Column(name = "samo_fund_ma10", precision = 15)
    private BigDecimal samoFundMa10;

    @Column(name = "samo_fund_ma20", precision = 15)
    ...
    @Column(name = "samo_fund_ma60", precision = 15)
    ...
    // 국가 (Nation)
    @Column(name = "natn_ma5", precision = 15)
    private BigDecimal natnMa5;

    @Column(name = "natn_ma10", precision = 15)
    private BigDecimal natnMa10;

    @Column(name = "natn_ma20", precision = 15)
    ...
    @Column(name = "natn_ma60", precision = 15)
    ...
    // 기타법인 (Etc Corp)
    @Column(name = "etc_corp_ma5", precision = 15)
    private BigDecimal etcCorpMa5;

    @Column(name = "etc_corp_ma10", precision = 15)
    private BigDecimal etcCorpMa10;

    @Column(name = "etc_corp_ma20", precision = 15)
    ...
    @Column(name = "etc_corp_ma60", precision = 15)
    ...
    // 내외국인 (Natfor)
    @Column(name = "natfor_ma5", precision = 15)
    private BigDecimal natforMa5;

    @Column(name = "natfor_ma10", precision = 15)
    private BigDecimal natforMa10;

    @Column(name = "natfor_ma20", precision = 15)
    ...
    @Column(name = "natfor_ma60", precision = 15)
